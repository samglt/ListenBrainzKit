...
public struct StatsRecordingsRequest: APIRequest {
    ...
    init(user: String?, count: Int?, offset: Int?, range: LBStatRange?) {
        ...
        if let user {
            self.data = .init(path: "/1/stats/user/\(user)/recordings",
                              method: .get,
                              queryItems: query,
                              headers: [:],
                              body: nil,
            ...
            self.data = .init(path: "/1/stats/sitewide/recordings",
                              method: .get,
                              queryItems: query,
                              headers: [:],
                              body: nil,
